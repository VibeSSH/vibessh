...
4. Open the authenticator app on your phone and scan the QR code from inside it (in Google Authenticator: **+** → **Scan a QR code**). Don't use the ordinary camera. If scanning doesn't work, type the key shown under the code into the app.
...
- **Scanning opens a notes app or plain text** - the code was scanned with the ordinary camera. Open the authenticator app and scan it from inside it.
