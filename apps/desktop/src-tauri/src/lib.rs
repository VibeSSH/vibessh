...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::application_template_commands::list_application_templates,
            commands::application_template_commands::save_application_template,
            commands::application_template_commands::delete_application_template,
            ...
            commands::cloud_commands::grant_team_node_access,
            commands::cloud_commands::revoke_team_node_access,
