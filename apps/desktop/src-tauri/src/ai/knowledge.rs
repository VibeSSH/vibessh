...
impl KeywordKnowledgeService {
    ...
    pub fn with_builtin_docs() -> Self {
        let documents: &[(&'static str, &'static str)] = &[
            ...
            // pair is forgotten.
            ("Guide - Nodes and applications", include_str!("../../../../../shared/guide/concepts.en.md")),
            ("Poradnik - Node i aplikacja", include_str!("../../../../../shared/guide/concepts.pl.md")),
            ("Guide - Getting started", include_str!("../../../../../shared/guide/getting-started.en.md")),
            ("Poradnik - Pierwsze kroki", include_str!("../../../../../shared/guide/getting-started.pl.md")),
            ("Guide - Walkthrough: two servers and a private database", include_str!("../../../../../shared/guide/scenario-two-nodes.en.md")),
            ("Poradnik - Scenariusz: dwa serwery i prywatna baza", include_str!("../../../../../shared/guide/scenario-two-nodes.pl.md")),
            ("Guide - Glossary", include_str!("../../../../../shared/guide/glossary.en.md")),
            ("Poradnik - Slowniczek", include_str!("../../../../../shared/guide/glossary.pl.md")),
            ("Guide - Dashboard", include_str!("../../../../../shared/guide/dashboard.en.md")),
            ("Poradnik - Panel", include_str!("../../../../../shared/guide/dashboard.pl.md")),
            ("Guide - Servers", include_str!("../../../../../shared/guide/servers.en.md")),
            ("Poradnik - Serwery", include_str!("../../../../../shared/guide/servers.pl.md")),
            ("Guide - Terminal", include_str!("../../../../../shared/guide/terminal.en.md")),
            ("Poradnik - Terminal", include_str!("../../../../../shared/guide/terminal.pl.md")),
            ("Guide - Monitor", include_str!("../../../../../shared/guide/monitor.en.md")),
            ("Poradnik - Monitor", include_str!("../../../../../shared/guide/monitor.pl.md")),
            ("Guide - Applications", include_str!("../../../../../shared/guide/applications.en.md")),
            ...
            ("Poradnik - Vibe Network", include_str!("../../../../../shared/guide/vibe-network.pl.md")),
            ("Guide - Actions", include_str!("../../../../../shared/guide/actions.en.md")),
            ("Poradnik - Akcje", include_str!("../../../../../shared/guide/actions.pl.md")),
            ("Guide - Firewall", include_str!("../../../../../shared/guide/firewall.en.md")),
            ("Poradnik - Firewall", include_str!("../../../../../shared/guide/firewall.pl.md")),
            ("Guide - SSH tunnels", include_str!("../../../../../shared/guide/port-forwarding.en.md")),
            ("Poradnik - Tunele SSH", include_str!("../../../../../shared/guide/port-forwarding.pl.md")),
            ("Guide - Databases", include_str!("../../../../../shared/guide/databases.en.md")),
            ("Poradnik - Bazy danych", include_str!("../../../../../shared/guide/databases.pl.md")),
            ("Guide - Account backend", include_str!("../../../../../shared/guide/cloud-backend.en.md")),
            ("Poradnik - Backend kont", include_str!("../../../../../shared/guide/cloud-backend.pl.md")),
            ("Guide - Teams", include_str!("../../../../../shared/guide/teams.en.md")),
            ("Poradnik - Zespoly", include_str!("../../../../../shared/guide/teams.pl.md")),
            ("Guide - Vibe AI", include_str!("../../../../../shared/guide/vibe-ai.en.md")),
            ("Poradnik - Vibe AI", include_str!("../../../../../shared/guide/vibe-ai.pl.md")),
            ("Guide - Settings", include_str!("../../../../../shared/guide/settings.en.md")),
            ...
            // pages the "?" next to an application's type opens. Written for
            // somebody who has not done it before, so the assistant answering
            // "how do I set up phpMyAdmin" gives the same steps the page does.
            ("Guide - Paper", include_str!("../../../../../shared/guide/app-paper.en.md")),
            ("Poradnik - Paper", include_str!("../../../../../shared/guide/app-paper.pl.md")),
            ("Guide - Purpur", include_str!("../../../../../shared/guide/app-purpur.en.md")),
            ("Poradnik - Purpur", include_str!("../../../../../shared/guide/app-purpur.pl.md")),
            ("Guide - Velocity", include_str!("../../../../../shared/guide/app-velocity.en.md")),
            ("Poradnik - Velocity", include_str!("../../../../../shared/guide/app-velocity.pl.md")),
            ("Guide - Waterfall", include_str!("../../../../../shared/guide/app-waterfall.en.md")),
            ("Poradnik - Waterfall", include_str!("../../../../../shared/guide/app-waterfall.pl.md")),
            ("Guide - Java application", include_str!("../../../../../shared/guide/app-generic-java.en.md")),
            ("Poradnik - Aplikacja Java", include_str!("../../../../../shared/guide/app-generic-java.pl.md")),
            ("Guide - Docker container", include_str!("../../../../../shared/guide/app-generic-docker.en.md")),
            ("Poradnik - Kontener Docker", include_str!("../../../../../shared/guide/app-generic-docker.pl.md")),
            ("Guide - Generic application", include_str!("../../../../../shared/guide/app-generic.en.md")),
            ...
            ("Poradnik - phpMyAdmin", include_str!("../../../../../shared/guide/app-phpmyadmin.pl.md")),
            ("Guide - Redis", include_str!("../../../../../shared/guide/app-redis.en.md")),
            ("Poradnik - Redis", include_str!("../../../../../shared/guide/app-redis.pl.md")),
            ("Guide - NATS", include_str!("../../../../../shared/guide/app-nats.en.md")),
            ("Poradnik - NATS", include_str!("../../../../../shared/guide/app-nats.pl.md")),
            ("Guide - Node.js bot", include_str!("../../../../../shared/guide/app-nodejs-bot.en.md")),
            ("Poradnik - Bot Node.js", include_str!("../../../../../shared/guide/app-nodejs-bot.pl.md")),
            ("Guide - Python bot", include_str!("../../../../../shared/guide/app-python-bot.en.md")),
            ("Poradnik - Bot Python", include_str!("../../../../../shared/guide/app-python-bot.pl.md")),
...
mod guide_corpus_tests {
    ...
    ///
    /// The Guide page loads `shared/guide` as a directory, so adding a file is
    ...
    fn every_guide_document_is_in_the_corpus() {
        let dir = std::path::Path::new(env!("CARGO_MANIFEST_DIR")).join("../../../shared/guide");
        let service = KeywordKnowledgeService::with_builtin_docs();
        let corpus: String = service.sections.iter().map(|section| section.body.as_str()).collect::<Vec<_>>().join("\n");

        let mut checked = 0;
        for entry in std::fs::read_dir(&dir).expect("shared/guide should exist") {
