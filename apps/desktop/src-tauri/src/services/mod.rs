...
pub mod shared_application_service;
mod purpur_service;
mod server_service;
mod ssh_service;
...
pub use application_files_service::{
    clear_file_history, compress as compress_application_files, copy as copy_application_file, fetch_url as fetch_application_file_url, prepare_drag_out as prepare_application_file_drag_out, create_directory as create_application_directory, delete as delete_application_file,
