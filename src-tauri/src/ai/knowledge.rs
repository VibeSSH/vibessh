...
impl KeywordKnowledgeService {
    ...
    pub fn with_builtin_docs() -> Self {
        let documents: &[(&'static str, &'static str)] = &[
            ...
            ("Poradnik - Panel", include_str!("../../../docs/guide/dashboard.pl.md")),
            ("Guide - Servers", include_str!("../../../docs/guide/servers.en.md")),
            ("Poradnik - Serwery", include_str!("../../../docs/guide/servers.pl.md")),
            ("Guide - Terminal", include_str!("../../../docs/guide/terminal.en.md")),
            ("Poradnik - Terminal", include_str!("../../../docs/guide/terminal.pl.md")),
            ("Guide - Monitor", include_str!("../../../docs/guide/monitor.en.md")),
            ("Poradnik - Monitor", include_str!("../../../docs/guide/monitor.pl.md")),
            ...
            ("Guide - Actions", include_str!("../../../docs/guide/actions.en.md")),
            ("Poradnik - Akcje", include_str!("../../../docs/guide/actions.pl.md")),
            ("Guide - Firewall", include_str!("../../../docs/guide/firewall.en.md")),
            ("Poradnik - Firewall", include_str!("../../../docs/guide/firewall.pl.md")),
            ("Guide - SSH tunnels", include_str!("../../../docs/guide/port-forwarding.en.md")),
            ...
            ("Poradnik - Vibe AI", include_str!("../../../docs/guide/vibe-ai.pl.md")),
            ("Guide - Settings", include_str!("../../../docs/guide/settings.en.md")),
            ("Poradnik - Ustawienia", include_str!("../../../docs/guide/settings.pl.md")),
            ...
            ("Guide - Paper", include_str!("../../../docs/guide/app-paper.en.md")),
            ("Poradnik - Paper", include_str!("../../../docs/guide/app-paper.pl.md")),
            ("Guide - Purpur", include_str!("../../../docs/guide/app-purpur.en.md")),
            ("Poradnik - Purpur", include_str!("../../../docs/guide/app-purpur.pl.md")),
            ("Guide - Velocity", include_str!("../../../docs/guide/app-velocity.en.md")),
            ("Poradnik - Velocity", include_str!("../../../docs/guide/app-velocity.pl.md")),
            ("Guide - Waterfall", include_str!("../../../docs/guide/app-waterfall.en.md")),
            ("Poradnik - Waterfall", include_str!("../../../docs/guide/app-waterfall.pl.md")),
            ("Guide - Java application", include_str!("../../../docs/guide/app-generic-java.en.md")),
            ("Poradnik - Aplikacja Java", include_str!("../../../docs/guide/app-generic-java.pl.md")),
            ("Guide - Docker container", include_str!("../../../docs/guide/app-generic-docker.en.md")),
            ("Poradnik - Kontener Docker", include_str!("../../../docs/guide/app-generic-docker.pl.md")),
            ("Guide - Generic application", include_str!("../../../docs/guide/app-generic.en.md")),
            ("Poradnik - Aplikacja ogolna", include_str!("../../../docs/guide/app-generic.pl.md")),
            ("Guide - MariaDB", include_str!("../../../docs/guide/app-mariadb.en.md")),
            ("Poradnik - MariaDB", include_str!("../../../docs/guide/app-mariadb.pl.md")),
            ("Guide - MongoDB", include_str!("../../../docs/guide/app-mongodb.en.md")),
            ("Poradnik - MongoDB", include_str!("../../../docs/guide/app-mongodb.pl.md")),
            ("Guide - phpMyAdmin", include_str!("../../../docs/guide/app-phpmyadmin.en.md")),
            ("Poradnik - phpMyAdmin", include_str!("../../../docs/guide/app-phpmyadmin.pl.md")),
            ("Guide - Redis", include_str!("../../../docs/guide/app-redis.en.md")),
            ("Poradnik - Redis", include_str!("../../../docs/guide/app-redis.pl.md")),
            ("Guide - NATS", include_str!("../../../docs/guide/app-nats.en.md")),
            ("Poradnik - NATS", include_str!("../../../docs/guide/app-nats.pl.md")),
            ("Guide - Node.js bot", include_str!("../../../docs/guide/app-nodejs-bot.en.md")),
