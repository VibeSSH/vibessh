...
export function Dashboard() {
  ...
  return (
    <div className="page">
      ...
      {servers.length === 0 ? (
        <Card>
          <EmptyState icon="server" title={t("dashboard.emptyTitle")} description={t("dashboard.emptyDescription")} />
        </Card>
      ) : (
